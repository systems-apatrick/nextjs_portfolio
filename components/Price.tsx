	...
	return (
		<div className='pt-[5rem] pb-[3rem] bg-black'>
			...
			<div className='w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 items-center pt-[4rem] md:pt-[7rem]'>
				<PriceCard plane='Basic' price='10$' save='24%' bg='bg-blue-900' />
				<PriceCard plane='Popular' price='50$' save='50%' bg='bg-green-900' />
				<PriceCard plane='Premium' price='100$' save='90%' bg='bg-red-900' />
			</div>
		</div>
	);
};
